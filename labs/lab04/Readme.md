...
<h2> Топология </h2>
<img src=https://github.com/Avasekho/otus-networks-pro/lab04/topology.png>
...
<p> - на коммутаторах SW2-SW5 в МСК настроен Rapid PVST, на маршрутизаторах R12-R13 оба интерфейса объединены в bridge-group, оба бриджа объединены в VRRP.
 аналогично на маршрутизаторах R16-R17 в СПб</p>
...
| Устройство |  Интерфейс  |    IPv4-адрес      |       Комментарий        |
|:----------:|:-----------:|:------------------:|:------------------------:|
| VPC30       | Eth0       | 10.14.130.100/24   | VLAN101                  |
| VPC31       | Eth0       | 10.14.131.100/24   | VLAN107                  |
|:----------:|:-----------:|:------------------:|:------------------------:|
