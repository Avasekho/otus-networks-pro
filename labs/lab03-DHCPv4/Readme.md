...
<p> Настраиваем базовую конфигурацию маршрутизаторов в соответствии с заданием. Настраиваем субинтерфейсы на R1; настраиваем шлюз по умолчанию для R1 и R2, добавляем статические маршруты для подсетей A, B и C: </p>
